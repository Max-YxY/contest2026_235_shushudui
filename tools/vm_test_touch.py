#!/usr/bin/env python3
"""Test touch feedback on ESP32-P4 board."""
...
# Read output for 20 seconds to capture touch events
timeout 20 cat /dev/ttyACM0 2>/dev/null

# Close port
exec 3>&-
SCRIPT

chmod +x /tmp/test_touch.sh

# Run the test
echo "Running touch test..."
echo "Please touch the screen when instructed!"
echo ""
/tmp/test_touch.sh 2>&1
